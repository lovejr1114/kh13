...
//JWT 생성
//- 사용자가 로그인을 성공하면 사용자의 주요 정보를 담아서 토큰으로 생성
//- 사용자가 토큰을 알아볼 수 없도록 서명(sign)을 추가
//- 서명을 위해서는 암호화 알고리즘이 필요, 그리고 암호화에 사용할 키(key)가 필요
//- 알고리즘과 키는 절대로 들키면 안된다.
//- JWT 라이브러리 중에서 JJWT를 사용한다.
@Slf4j
@SpringBootTest
public class JwtTest01 {
	...
	public void test() {
		...
		String keyStr = "zpdldpdlclwjdqhrydbrdnjsrlawjddms"; //keyString , 충분히 길게 작성 (32글자 이상)
