...
public class KakaoPayCancelResponseVO {
	...
	private KakaoPayAmountVO approvedCancelAmoutnt; //이번에 취소된 금액 정보
	private KakaoPayAmountVO canceledAmont; //누적 취소 금액 정보
	...
	private String payload; //취소 요청 시 전달한 파라미터(값)
}
