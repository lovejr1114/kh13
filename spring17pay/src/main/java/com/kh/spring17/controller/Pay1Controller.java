...
import com.kh.spring17.vo.KakaoPayApproveRequestVO.KakaoPayApproveRequestVOBuilder;
...
public class Pay1Controller {
	...
	public String purchase(@ModelAttribute KakaoPayReadyRequestVO requestVO,
...
//		log.debug("tid = {}", requestVO.getTid());
