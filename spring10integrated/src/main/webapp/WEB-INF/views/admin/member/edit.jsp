...
<%--
	추가로 전달할 정보 - 아이디 (hidden으로 넘긴다)
	수정해야 할 정보 -  닉네임, 이메일, 생년월일, 연락처, 주소,(+ 등급, 포인트)
	
	*폼을 만들 때는 몇개를 만들어야하는지 먼저 개수를 파악해라
 --%>
<form action="edit" method="post">
	...
	<br><br>
	포인트 <input type="number" name="memberPoint" value="${memberDto.memberPoint}"  required> <br><br>
